...
#
# def test_fold_ising_hr_imp_zipup(dense_ising_hr_imp):
#     assert mps.mps_to_dense(mps.im_iterative(mps.fold.ising_hr_Tp(*dense_ising_hr_imp[1]),chi=64))==pytest.approx(dense_ising_hr_imp[0])
#
# # @pytest.mark.xfail
