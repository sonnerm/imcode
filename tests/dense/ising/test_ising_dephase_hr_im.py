...
# @pytest.mark.xfail
# def test_flat_ising_dephase_hr_im_dmrg(dense_ising_dephase_hr_im):
#     assert mps.mps_to_dense(mps.im_dmrg(mps.flat.ising_dephase_hr_T(*dense_ising_dephase_hr_im[1])))==pytest.approx(dense_ising_dephase_hr_im[0])
