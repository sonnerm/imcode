...
@pytest.fixture(scope="module")
def dense_ising_H_complex_obc():
    L=5
    seed_rng("dense_ising_H_complex_obc")
...
def test_mps_ising_H_complex_obc(dense_ising_H_complex_obc):
    miH=mps.ising_H(*dense_ising_H_complex_obc[1])
    assert mps.mpo_to_dense(miH)==pytest.approx(dense_ising_H_complex_obc[0])
