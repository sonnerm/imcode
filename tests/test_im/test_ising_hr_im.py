...
def test_mps_ising_hr_im_iterative(dense_ising_hr_im):
    assert mps.mps_to_dense(mps.im_iterative(mps.ising_hr_T(*dense_ising_hr_im[1])))==pytest.approx(dense_ising_hr_im[0])
@pytest.mark.xfail
def test_mps_ising_hr_im_dmrg(dense_ising_hr_im):
    assert mps.mps_to_dense(mps.im_dmrg(mps.ising_hr_T(*dense_ising_hr_im[1])))==pytest.approx(dense_ising_hr_im[0])
