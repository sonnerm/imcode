...
def correlation_coefficients(T_tilde,T_tilde_mod, nsites, nbr_Floquet_layers):
    ...
    A_mod = np.zeros((2, 2, nbr_Floquet_layers, 2*nsites), dtype=np.complex_)
    ...
    for tau in range(0, nbr_Floquet_layers):
        ...
        A_mod[0, 0, tau] = T_tilde_fw_0_mod - T_tilde_fw_L_mod
        # arguments: forward branch, "Zeta/+ Majorana"
        A_mod[0, 1, tau] = T_tilde_fw_0_mod + T_tilde_fw_L_mod
        # arguments: backward branch, "Theta/- Majorana"
        A_mod[1, 0, tau] = T_tilde_bw_0_mod - T_tilde_bw_L_mod
        # arguments: backward branch, "Zeta/+ Majorana"
        A_mod[1, 1, tau] = T_tilde_bw_0_mod + T_tilde_bw_L_mod
