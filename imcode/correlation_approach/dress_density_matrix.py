...
def dress_density_matrix(rho_0, G_eff, nbr_Floquet_layers):
    ...
    rho_dressed = - linalg.logm(einsum('ij,jk,kl->il', matrix_power(expm(0.5j* G_eff[0]),nbr_Floquet_layers) ,expm(- rho_0) ,matrix_power(expm(-0.5j* G_eff[1]),nbr_Floquet_layers)) )
